...
#                               ชื่อ VERIFY_BOT_TOKEN ใน Render Dashboard แทน
# -----------------------------------------------------------------------------
import os
BOT_TOKEN = os.environ.get("VERIFY_BOT_TOKEN", "")  # ถ้าไม่มี env var จะใช้ค่าว่าง
...
def main():
    ...
    if not token:
        ...
        print("วิธีที่ 2 (Render): ตั้ง Environment Variable ชื่อ VERIFY_BOT_TOKEN")
        print("=" * 60)
        return
    client.run(token)
